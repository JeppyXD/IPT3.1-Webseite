                    ...
                    <div>
                        ...
                        <div class="flex-container" >
                            ...
                            <div class="flex-item2" style="margin: auto 1vw;">
                                <h2 style="margin-bottom: -0.25vw; font-size: 30px;" class="center"><?php echo $row["price"];?> CR</h2>
                                <table width="100%">
                                    <tr>
                                        <th>
                                            <div style="margin:0.5vw">
                ...
                <li class="carlist">
                    <div>
                        ...
                        <div class="flex-container" >
                            ...
                            <div class="flex-item2" style="margin: auto 1vw;">
                                <h2 style="margin-bottom: -0.25vw; font-size: 1.5vw;" class="center"><?php echo $row["price"];?> CR</h2>
                                <table width="100%">
                                    <tr>
                                        <th>
                                            <div style="margin:0.5vw">
